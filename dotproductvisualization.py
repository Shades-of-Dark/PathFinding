...
class Player():
    def __init__(self):
        self.rect = pygame.Rect(50, 100, 1, 1)
        self.movement = pygame.Vector2(1, 0)
        self.speed = 5
        self.angle = 0
    ...
    #    pygame.draw.line(surf, (255, 255, 255), (450, 250), self.rect.center, 3)
        pygame.draw.line(surf, (0, 0, 255), (self.rect.centerx, 250), self.rect.center, 3)
        pygame.draw.line(surf, (255,255,255), (self.rect.centerx, 250), (250, 250), 3)
        print(self.rect.centerx - copysign(15, self.movement.x), self.rect.centerx)

        pygame.draw.rect(surf, (255, 255, 255), pygame.Rect(self.rect.centerx - copysign(15, self.movement.x) , 250 + copysign(15, self.movement.y), 15, 15), 2)
...
while True:
    ...
    font.render(screen, "Angle: " + str(round(angle * pi/180, 1)), (255, 255, 255), (20, 50), 4, (0, 0, 0), False)
    font.render(screen, f"({round(cos(angle), 1)}, {round(sin(angle), 1)})", (255, 255, 255), (310, 10), 3, (0, 0, 0), False)
    goodGuy.draw(screen)
    badGuy.draw(screen)
